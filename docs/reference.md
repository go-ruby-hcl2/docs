...
The public API lives at the module root (`github.com/go-ruby-hcl2/hcl2`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `hcl2`, while the surface follows
...
```go
import "github.com/go-ruby-hcl2/hcl2"
```
...
- **[pkg.go.dev/github.com/go-ruby-hcl2/hcl2](https://pkg.go.dev/github.com/go-ruby-hcl2/hcl2)**

The module's [README](https://github.com/go-ruby-hcl2/hcl2#readme) carries worked
