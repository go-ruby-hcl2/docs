# go-ruby-hcl2 documentation

**Pure-Go (CGO=0) from-scratch HCL2 parser + evaluator for the Ruby value model**

`go-ruby-hcl2/hcl2` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `hcl2`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `hcl2`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`hcl2`](https://github.com/go-ruby-hcl2/hcl2) | the library — Ruby's `hcl2` in pure Go |
| [`docs`](https://github.com/go-ruby-hcl2/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-hcl2.github.io`](https://github.com/go-ruby-hcl2/go-ruby-hcl2.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-hcl2/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-hcl2/hcl2](https://github.com/go-ruby-hcl2/hcl2).
