...
`go-ruby-hcl2/hcl2` reimplements Ruby's `hcl2` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-hcl2/hcl2` directly, with no Ruby runtime;
