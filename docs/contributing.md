...
Contributions are welcome. `go-ruby-hcl2/hcl2` is built to a small set of
...
The library is in [`github.com/go-ruby-hcl2/hcl2`](https://github.com/go-ruby-hcl2/hcl2).
This documentation site is in [`github.com/go-ruby-hcl2/docs`](https://github.com/go-ruby-hcl2/docs).
